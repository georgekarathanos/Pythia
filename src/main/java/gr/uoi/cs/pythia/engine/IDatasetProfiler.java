...
public interface IDatasetProfiler {
	...
	/**
	 * Declares which of the alternatives for outlier detection we will use, 
	 * and with what threshold we decide if a value is an outlier
	 *  
	 * @param outlierType the OutlierType that determines the algo that is executed
